...
const FooterLinks = ({ heading, items }) => (
  <div className='flex-1 justify-star items-start'>
    ...
    {items.map((item, index) => (
      <p
        key={index}
        className='font-poppins dark:text-white text-nft-black-1 font-normal text-base cursor-pointer dark:hover:text-nft-gray-2 hover:text-nft-gray-2 my-3'
      >
        {item}
      </p>
    ))}
